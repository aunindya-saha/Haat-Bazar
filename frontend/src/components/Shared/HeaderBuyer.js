    ...
    >
      ...
      <div className="container mx-auto relative px-6 py-4">
        ...
        <div className="flex space-x-10 absolute top-24 left-1/2 transform -translate-x-1/2 text-xl font-bold">
          <a href="/buyer/home" className="text-white hover:text-green-300">
            হোম
          </a>
          <a href="/buyer/categories" className="text-white hover:text-green-300">
            কার্ট
          </a>
          <a href="/buyer/orders" className="text-white hover:text-green-300">
            অভিযোগ
          </a>
          <a href="/buyer/account" className="text-white hover:text-green-300">
            পূর্ববর্তী ক্রয়
          </a>
          <Link to="/buyerHomepage/buyerFraudList" className="text-white hover:text-green-300">
            প্রতারক তালিকা
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4 absolute top-24 right-6">
          <a
            href="/buyer/cart"
            className="bg-green-600 hover:bg-green-800 px-4 py-2 rounded-md text-sm"
          >
            Cart
          </a>
          <a
            href="/buyer/logout"
            className="bg-red-600 hover:bg-red-800 px-4 py-2 rounded-md text-sm"
          >
            Logout
          </a>
        </div>
